(function () {
  ...
  function navMarkup(active) {
    var items = [
      { key: "inbox", href: "index.html", label: "问答工作台" },
      { key: "search", href: "search.html", label: "检索实验台" },
      { key: "detail", href: "detail.html", label: "证据详情" },
      { key: "ops", href: "ops.html", label: "评估运维板" }
    ];
