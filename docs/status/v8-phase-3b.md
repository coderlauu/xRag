...
- `key_commits`: `1566163` 为 v8 Phase 3B 最终 main baseline；`e5e4180` 为 docs closeout；`0de02de` 为实现 closeout；`991725c` 为 v7 上游基线
- `latest_ci_run`: `24623440591 success (v8 Phase 3B final — all jobs green)`
