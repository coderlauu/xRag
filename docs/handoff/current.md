...
在 `Phase 2A` 可信问答闭环完成后，已把 `Phase 2B` 的核心范围冻结为“范围控制增强、检索解释、证据包增强与历史工作流”，并保留 `ops` 面板为次级增强。
...
- `PRD / backlog / interaction delta / technical tradeoff` 已形成最小事实源
...
- `Phase 2B` 的 `PRD / backlog / interaction delta / technical tradeoff` 已补齐第一版
...
10. [Phase 2A PRD](/Users/coderlauu/xRag/docs/prd/2026-04-07-xrag-phase-2a-prd.md)
11. [Phase 2A Backlog](/Users/coderlauu/xRag/docs/prd/2026-04-07-xrag-phase-2a-backlog.md)
12. [v4 Interaction Spec](/Users/coderlauu/xRag/design/spec/2026-04-07-v4-interaction-spec.md)

---

## 4. 执行规则

1. 当前有效版本为 `v5 / Phase 2B`，当前节点仍是 `planning-and-design`，但 `PRD / backlog / interaction delta / technical tradeoff` 第一版已完成
...
4. 在 `v5` 的产品边界、优先级和 tradeoff 没冻结为 contract 之前，不启动新的 `schema / shared-types / API contract / 状态机` 改动，也不拆新的实现 lane
